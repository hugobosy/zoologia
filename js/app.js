// const collars = document.querySelector('[data-name=collars]');
// const div = document.querySelector('.collars');
// collars.addEventListener('mouseover', (e) => {
//     div.classList.add('active');
// });
// collars.addEventListener('mouseleave', () => {
